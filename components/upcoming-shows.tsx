...
export default function UpcomingShows() {
  ...
  return (
    <section ref={sectionRef} className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-3/4 right-70 w-20 h-20 rounded-full bg-accent/10 blob-small"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <a 
            ...
            className="inline-flex items-center gap-2 text-white hover:underline transition-all text-sm font-medium md:text-lg py-3 px-6 rounded-full"
          >
